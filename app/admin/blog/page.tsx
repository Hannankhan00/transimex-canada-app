  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      ...
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-2xs overflow-hidden">
        ...
        {/* Posts Table (Preserved on Desktop) */}
            ...
            filteredPosts.map((post) => {
              ...
              return (
                <div key={post.id} className="p-4 space-y-2.5">
                  ...
                  <div>
                    <h4 className="font-bold text-[#0B2545] text-xs leading-snug">{post.title.en}</h4>
                    <p className="text-[11px] text-slate-500 italic mt-0.5">{post.title.fr}</p>
                  </div>
